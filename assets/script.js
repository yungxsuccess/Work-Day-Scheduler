...
$(function() {
  ...
  // This function updates the current date and time display every second.
  function updateTime() {
  ...
  // Update the time once per second for the current time using setInterval(), providing a live time display in the header.
